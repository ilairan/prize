...
public class SecondFragment extends Fragment {
    ...
    TextView backButton;
    TextView scoreTextView;  // תוספת - להציג ניקוד
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        // אתחול ניקוד (במידה ויש לך TextView לניקוד במסך הזה)
        scoreTextView = view.findViewById(R.id.scoreTextView);  // נניח שיש ID כזה
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                fragmentManager.popBackStack();  // חזרה למסך הקודם

                // הצגת התפריט הראשי מחדש
